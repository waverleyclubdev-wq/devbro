/* @ts-self-types="./particle_sim.d.ts" */
...
export class Engine {
    ...
    static new(width, height, count) {
        const ret = wasm.engine_new(width, height, count);
     ...
     */
    tick() {
        const ret = wasm.engine_tick(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} x
     ...
     */
    update_mouse(x, y) {
        wasm.engine_update_mouse(this.__wbg_ptr, x, y);
    }
}
