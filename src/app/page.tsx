...
const MANUAL_PAGES = [
  ...
  },
  {
    ...
    content: "Using your GPU / CPU to render because it saves me server costs, and warms up your lap or palms. You're welcome.",
    icon: "🔥"
  },
  {
    title: "04 // PING",
  ...
  return (
    <main className={`relative min-h-screen bg-black text-white overflow-hidden font-mono selection:bg-emerald-500 selection:text-black ${isOverclocked ? "shake-screen" : ""}`}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <h1 className="select-none text-6xl md:text-8xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-500">
          I write Code.
        </h1>

        {/* FUNKY MAGICAL SUBTITLE */}
        <motion.p
          className="select-none text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 drop-shadow-[0_0_5px_rgba(232,121,249,0.5)] max-w-xl mx-auto mb-10 italic tracking-wide"
        >
          on weekends.. ✨
        </motion.p>
